...
<body>
  ...
  <nav id="nav" class="nav" role="navigation">
    <section class="nav-section">
      ...
      <ul class="nav-menu" id="menu" tabindex="-1" aria-label="main navigation" hidden>
        <li class="nav-item"><a href="<?= $router->generate("home") ?>" class="nav-link">ACCUEIL</a>
        </li>
        <li class="nav-item">
          <a class="accordion nav-link">GENRES</a>
          <ul class="panel">
            <li><a href="<?= $router->generate("genre") ?>alternative">ALTERNATIVE</a></li>
            <li><a href="<?= $router->generate("genre") ?>blues">BLUES</a></li>
            <li><a href="<?= $router->generate("genre") ?>hiphop">HIP HOP</a></li>
            <li><a href="<?= $router->generate("genre") ?>rock">ROCK</a></li>
            <li><a href="<?= $router->generate("genre") ?>indie">INDIE</a></li>
            <li><a href="<?= $router->generate("genre") ?>metal">METAL</a></li>
            <li><a href="<?= $router->generate("genre") ?>pop">POP</a></li>
          </ul>
        </li>
        <li class="nav-item"><a href="<?= $router->generate("home") ?>#about" class="nav-link">À PROPOS</a></li>
    ...
    <section class="nav-desktop-section">
      <div class="navbar-desktop">
        ...
        <ul>
          ...
          <li>
            <div class="dropdown">
              ...
              <div class="dropdown-content">
                <a href="<?= $router->generate("genre") ?>alternative">ALTERNATIVE</a>
          ...
          <li><a href="<?= $router->generate("home") ?>#about">À PROPOS</a></li>
    ...
    <section class="footer-section">
      ...
      <article class="footer-article" data-aos="fade-up">
        <div class="admin">
          ...
          <div class="admin-item">
            <h2>Raphaël Dorce</h2>
            <a class="social-icon" href="https://github.com/DorceRaphael" target="_blank">
              <i class="fab fa-github-square"></i>
            </a>
            <a class="social-icon" href="https://www.linkedin.com/in/raphael-dorce-524a32148/" target="_blank">
              <i class="fab fa-linkedin"></i>
            </a>
          </div>
        </div>
  ...
  <!--------------------------------------------- SCRIPTS -->
  <script src="./assets/js/main_prod.js"></script>
  <?= $pageJavascripts ?? "" ?>
</body>
